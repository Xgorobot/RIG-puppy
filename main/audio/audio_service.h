...
private:
    ...
    // Audio encode / decode - task handles and PSRAM stacks
    TaskHandle_t audio_input_task_handle_ = nullptr;
    TaskHandle_t audio_output_task_handle_ = nullptr;
    TaskHandle_t opus_codec_task_handle_ = nullptr;
    
    // Static task resources for PSRAM stack allocation
    StackType_t* audio_input_stack_ = nullptr;
    StackType_t* audio_output_stack_ = nullptr;
    StackType_t* opus_codec_stack_ = nullptr;
    StaticTask_t audio_input_tcb_;
    StaticTask_t audio_output_tcb_;
    StaticTask_t opus_codec_tcb_;
