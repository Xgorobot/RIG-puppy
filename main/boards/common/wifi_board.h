...
public:
    ...
    /**
     * Notify WiFi connected from external source (e.g., BluFi)
     * This triggers the network connected event to Application
     */
    void NotifyWifiConnected(const std::string& ssid);
};
