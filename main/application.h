...
public:
     ...
     * Returns the level to restore to after active operations (conversation, OTA, etc.)
     */
    static PowerSaveLevel GetUserPowerSaveLevel();
    ...
    /**
     * Reset protocol resources synchronously (for use in scheduled tasks)
     * Can be called from any task to release resources allocated after network connected
     */
    void ResetProtocolSync();
