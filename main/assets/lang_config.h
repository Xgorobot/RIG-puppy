...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_activation_error_start[] asm("_binary_activation_error_ogg_start");
        extern const char ogg_activation_error_end[] asm("_binary_activation_error_ogg_end");
        static const std::string_view OGG_ACTIVATION_ERROR {
        static_cast<const char*>(ogg_activation_error_start),
        static_cast<size_t>(ogg_activation_error_end - ogg_activation_error_start)
        };
        ...
        extern const char ogg_calibration_enter_start[] asm("_binary_calibration_enter_ogg_start");
        extern const char ogg_calibration_enter_end[] asm("_binary_calibration_enter_ogg_end");
        static const std::string_view OGG_CALIBRATION_ENTER {
        static_cast<const char*>(ogg_calibration_enter_start),
        static_cast<size_t>(ogg_calibration_enter_end - ogg_calibration_enter_start)
        };

        extern const char ogg_calibration_exit_start[] asm("_binary_calibration_exit_ogg_start");
        extern const char ogg_calibration_exit_end[] asm("_binary_calibration_exit_ogg_end");
        static const std::string_view OGG_CALIBRATION_EXIT {
        static_cast<const char*>(ogg_calibration_exit_start),
        static_cast<size_t>(ogg_calibration_exit_end - ogg_calibration_exit_start)
        };

        extern const char ogg_connect_error_start[] asm("_binary_connect_error_ogg_start");
        extern const char ogg_connect_error_end[] asm("_binary_connect_error_ogg_end");
        static const std::string_view OGG_CONNECT_ERROR {
        static_cast<const char*>(ogg_connect_error_start),
        static_cast<size_t>(ogg_connect_error_end - ogg_connect_error_start)
        };

        extern const char ogg_connecting_start[] asm("_binary_connecting_ogg_start");
        extern const char ogg_connecting_end[] asm("_binary_connecting_ogg_end");
        static const std::string_view OGG_CONNECTING {
        static_cast<const char*>(ogg_connecting_start),
        static_cast<size_t>(ogg_connecting_end - ogg_connecting_start)
        };

        extern const char ogg_close_aec_start[] asm("_binary_close_aec_ogg_start");
        extern const char ogg_close_aec_end[] asm("_binary_close_aec_ogg_end");
        static const std::string_view OGG_CLOSE_AEC {
        static_cast<const char*>(ogg_close_aec_start),
        static_cast<size_t>(ogg_close_aec_end - ogg_close_aec_start)
        };

        extern const char ogg_enter_remote_start[] asm("_binary_enter_remote_ogg_start");
        extern const char ogg_enter_remote_end[] asm("_binary_enter_remote_ogg_end");
        static const std::string_view OGG_ENTER_REMOTE {
        static_cast<const char*>(ogg_enter_remote_start),
        static_cast<size_t>(ogg_enter_remote_end - ogg_enter_remote_start)
        };
        ...
        extern const char ogg_exit_remote_start[] asm("_binary_exit_remote_ogg_start");
        extern const char ogg_exit_remote_end[] asm("_binary_exit_remote_ogg_end");
        static const std::string_view OGG_EXIT_REMOTE {
        static_cast<const char*>(ogg_exit_remote_start),
        static_cast<size_t>(ogg_exit_remote_end - ogg_exit_remote_start)
        };

        extern const char ogg_hi_start[] asm("_binary_hi_ogg_start");
        extern const char ogg_hi_end[] asm("_binary_hi_ogg_end");
        static const std::string_view OGG_HI {
        static_cast<const char*>(ogg_hi_start),
        static_cast<size_t>(ogg_hi_end - ogg_hi_start)
        };
        ...
        extern const char ogg_open_aec_start[] asm("_binary_open_aec_ogg_start");
        extern const char ogg_open_aec_end[] asm("_binary_open_aec_ogg_end");
        static const std::string_view OGG_OPEN_AEC {
        static_cast<const char*>(ogg_open_aec_start),
        static_cast<size_t>(ogg_open_aec_end - ogg_open_aec_start)
        };

        extern const char ogg_pain_start[] asm("_binary_pain_ogg_start");
        extern const char ogg_pain_end[] asm("_binary_pain_ogg_end");
        static const std::string_view OGG_PAIN {
        static_cast<const char*>(ogg_pain_start),
        static_cast<size_t>(ogg_pain_end - ogg_pain_start)
        };
        ...
        extern const char ogg_reconnect_start[] asm("_binary_reconnect_ogg_start");
        extern const char ogg_reconnect_end[] asm("_binary_reconnect_ogg_end");
        static const std::string_view OGG_RECONNECT {
        static_cast<const char*>(ogg_reconnect_start),
        static_cast<size_t>(ogg_reconnect_end - ogg_reconnect_start)
        };
        ...
        static const std::string_view OGG_WOOF {
        static_cast<const char*>(ogg_woof_start),
        static_cast<size_t>(ogg_woof_end - ogg_woof_start)
        };
    }
}
